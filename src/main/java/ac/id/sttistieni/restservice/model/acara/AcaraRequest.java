...
public class AcaraRequest implements Serializable {
    String acaraId;
    String acaraTitle;
    String acaraContent;
    String acaraAuthor;
    ...
    public AcaraRequest(String acaraId, String acaraTitle, String acaraContent, String acaraAuthor, String location, Date startDate, Date endDate, String thumbnail, String category, Boolean isShowing) {
